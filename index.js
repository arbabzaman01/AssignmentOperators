...
const taxRate = 0.08;
const finalPrice = totalPrice * totalPrice * taxRate;
...
/*Create an object user with properties name and age.
 Set the initial values to "John" and 30, respectively. Use
 the appropriate assignment operators to update the name
 to "Alice" and increment the age by 5. Print the updated object.*/
